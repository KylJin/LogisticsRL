...
class Truck(object):
    def __init__(self, size, start_position, end_position, trans_time):
        ...
        self.font = pygame.font.Font(osp.join(resource_path, "font/arial.ttf"), 14)
...
class LogisticsInterface(object):
    def __init__(self, width, height, network_data):
        ...
        self.font1 = pygame.font.Font(osp.join(resource_path, "font/arial.ttf"), 24)
        self.font2 = pygame.font.Font(osp.join(resource_path, "font/arial.ttf"), 18)
        self.font3 = pygame.font.Font(osp.join(resource_path, "font/arial.ttf"), 14)
        self.font4 = pygame.font.Font(osp.join(resource_path, "font/simhei.ttf"), 14)
